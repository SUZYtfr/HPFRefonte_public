  ...
  <div :class="['news', 'px-3']">
    ...
    <div class="columns is-vcentered is-mobile mb-1">
      <div class="column">
        <h3 class="h3 is-inline">
          <NuxtLink prefetch-on="interaction" class="pl-0" :to="{ name: 'news-id', params: { id: news.newsId } }">
            {{ news.title }}
          </NuxtLink>
        </h3>
        <BButton
    ...
    <div class="columns is-vcentered is-mobile mt-1 mb-0">
      <div class="column pt-2 pb-1">
        ...
        <span> par </span>
        <span v-for="(author, index) in news.authors" :key="author.userId.toString()" class="has-text-weight-semibold">
