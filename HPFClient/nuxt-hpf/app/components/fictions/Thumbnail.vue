<template>
  <div :class="[{ 'fanfiction-hover': hover }, 'fanfiction']" @mouseover="hover = true" @mouseleave="hover = false">
    ...
    <div class="is-flex is-flex-direction-row is-flex-wrap-nowrap is-justify-content-start is-align-items-center">
      ...
      <div class="overflow-hidden white-space-nowrap">
        <NuxtLink
          ...
          :key="'ff_' + fanfiction.fanfictionId + '_characteristic_' + characteristic.characteristicId.toString()"
          :to="{
            name: 'recherche',
            query: {
              fandoms: fandom?.id,
