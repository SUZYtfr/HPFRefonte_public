...
class FictionAdminPage(BaseAdminPage):
    ...
    fieldsets = [
        (None, {
            "fields": ("title", "storynote", "summary", "status", "rating", "featured", "published"),
        }),
        ("Caractéristiques", {
...
class ChapterAdminPage(BaseAdminPage):
    ...
    fieldsets = [
        (None, {
            "fields": ("fiction", "title", "start_note", "end_note", "publication_date", "read_count", "text", "trigger_warnings"),
        }),
        ("Statistiques", {
